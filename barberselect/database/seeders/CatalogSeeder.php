    ...
    public function run(): void
    {
        $catalogs = [
            [
                ...
                'image_url' => 'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
            ],
            [
                ...
                'image_url' => 'https://images.unsplash.com/photo-1595152772835-219674b2a8a6?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
            ],
            [
                'name' => 'Curly Waves',
                'category_name' => 'Curly',
                'description' => 'Gelombang rambut keriting yang memberikan tampilan alami dan menawan. Cocok untuk rambut bertekstur.',
                'image_url' => 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
            ],
            [
                'name' => 'French Crop',
                ...
                'image_url' => 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
            ],
            [
                'name' => 'Textured Crop',
                'category_name' => 'Modern',
                ...
                'image_url' => 'https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
            ],
            [
                'name' => 'Layered Bob',
                ...
                'image_url' => 'https://images.unsplash.com/photo-1505920205502-9765a7b10f76?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
            ],
            [
                'name' => 'Mullet Revival',
                ...
                'image_url' => 'https://images.unsplash.com/photo-1533106418984-25c0a98fd033?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
            ],
            [
                'name' => 'Shag Cut',
                'category_name' => 'Layered',
                'description' => 'Potongan shag yang messy namun terlihat rapi. Memberikan tekstur dan gerakan alami pada rambut.',
                'image_url' => 'https://images.unsplash.com/photo-1542816411-73d6f26760df?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
            ],
        ];
