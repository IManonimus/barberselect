...
<head>
    ...
    <title>Edit Kategori - BarberSelect</title>
...
<body>
    ...
    <main class="main">
        <div class="topbar">
            <div>
                <h1>Edit Kategori</h1>
                <p>Perbarui nama dan gambar kategori layanan.</p>
            </div>
        ...
        <div class="card">
            <form method="POST" action="/admin/categories/{{ $category->id }}">
                ...
                <input id="image_url" name="image_url" type="url" value="{{ old('image_url', $category->image_url) }}" placeholder="https://example.com/foto.jpg">

                <button class="btn" type="submit">Perbarui Kategori</button>
            </form>
        </div>
    </main>
</body>
