...
<head>
    ...
    <title>Admin Kategori - BarberSelect</title>
    ...
    <main class="main">
        <div class="topbar">
            <div>
                ...
                <p>Tambah, edit, atau hapus kategori layanan.</p>
            </div>
            <a href="/admin/categories/create" class="btn-primary">➕ Tambah Kategori</a>
        </div>
        ...
        <div class="panel">
            ...
            <table class="table">
                <thead>
                    <tr><th style="width:90px;">ID</th><th style="width:90px;">Foto</th><th>Nama</th><th style="width:190px;">Aksi</th></tr>
                </thead>
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($category->image_url)
                                    <img src="{{ $category->image_url }}" alt="{{ $category->name }}" class="thumb">
                                @else
                                    —
                                @endif
                            </td>
