...
<head>
    ...
    <title>Tambah Katalog - BarberSelect</title>
    ...
    <main class="main">
        <div class="topbar">
            <div>
                ...
                <p>Tambah item katalog gaya rambut untuk ditampilkan ke user.</p>
            </div>
            ...
            <form method="POST" action="/admin/catalogs">
                ...
                <div class="grid">
                    ...
                    <div>
                        ...
                        <input id="care_level" name="care_level" type="text" value="{{ old('care_level') }}" placeholder="Contoh: Sedang">
                    </div>
                    <div>
                        <label for="face_shape">Cocok untuk Bentuk Wajah</label>
                        <input id="face_shape" name="face_shape" type="text" value="{{ old('face_shape') }}" placeholder="Contoh: Oval, Bulat, Kotak">
                    </div>
                    <div class="span2">
                        <label for="hair_type">Jenis Rambut</label>
                        <input id="hair_type" name="hair_type" type="text" value="{{ old('hair_type') }}" placeholder="Contoh: Lurus, Bergelombang">
                    </div>
                    <div class="span2">
                        <label for="tips">Tips & Rekomendasi (1 tips per baris)</label>
                        <textarea id="tips" name="tips" rows="5" placeholder="Gunakan produk styling yang sesuai&#10;Potong rambut secara berkala">{{ old('tips') }}</textarea>
                    </div>
                    <div class="span2">
                ...
                <button class="btn" type="submit">Simpan Katalog</button>
            </form>
        </div>
    </main>
</body>
